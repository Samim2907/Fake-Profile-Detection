...
df["following_to_posts"] = df["following_count"] / (df["post_count"] + 1)
...
model = make_pipeline(StandardScaler(), SVC(C=5.0,gamma='scale',degree=3,shrinking=False,random_state=1))
